...
A patch: no wire, storage-format or API break; rolling upgrade. One change
to how the embedding worker spends provider calls, and the three settings
that bound it, whose defaults are meant to be left alone.

...
```bash
V=0.35.0; A=kimmy-cli-x86_64-unknown-linux-musl.tar.xz
...
gh attestation verify oci://ghcr.io/titusai-io/kimmydb:0.35.0 -R titusai-io/kimmydb
```
